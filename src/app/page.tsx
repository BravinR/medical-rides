    ...
    <div>
      ...
      <div className="relative">
        <Image
          ...
          src={backgroundImage}
          alt="Peak Elite Background Image"
        />
        <h1 className="absolute top-[200px] text-4xl text-center font-semibold text-white">
          Book your ride from anywhere today!
        </h1>
        <h1 className="absolute top-[300px] text-2xl text-center font-semibold text-white">
          Ride with Confidence: Reliable Non-Emergency Medical Transportation
          Services at Your Fingertips!
        </h1>
        <Link
          href="/schedule"
          className=" absolute top-[450px] focus:outline-none text-black bg-yellow-400 hover:bg-yellow-500 focus:ring-4 focus:ring-yellow-300 font-medium rounded-lg text-sm px-5 py-2.5 ml-32 mb-2"
        >
          Schedule a Ride
        </Link>
      </div>
      <div className="ml-4">
        ...
        <div>
          ...
          <p className="mb-6 text-lg font-normal text-gray-500 lg:text-xl sm:px-16 xl:px-48 ">
            Here at Peak Elite we understand that your safety and comfort are
            our top priorities. That&apos;s why we offer:{" "}
          </p>
          <a
            href="#"
            className="block max-w-sm p-6  border rounded-lg shadow bg-gray-800 "
          >
            <h5 className="mb-2 text-2xl font-bold tracking-tight text-white">
              Safety Guarantee:
            </h5>
            <p className="font-normal text-gray-400 ">
              Our drivers are carefully selected and thoroughly trained to
              ensure that they meet our high safety standards. Our vehicles are
              equipped with state-of-the-art technology to monitor and ensure
              the safety of each ride.
            </p>
          </a>
          <a
            href="#"
            className="mt-5 block max-w-sm p-6 border rounded-lg shadow  bg-gray-800"
          >
            <h5 className="mb-2 text-2xl font-bold tracking-tight text-white">
              Fast Pickups:
            </h5>
            <p className="font-normal text-gray-400 ">
              We know that time is of the essence, especially when it comes to
              medical appointments. That&apos;s why we pride ourselves on our
              fast pickup times. Our drivers are trained to arrive promptly and
          ...
          >
            ...
            <p className="font-normal text-gray-400">
              ...
              team is available 24/7 to answer your questions, make changes to
              your reservations, or help you with any other needs you may have.
            </p>
          </a>
        </div>
      </div>
