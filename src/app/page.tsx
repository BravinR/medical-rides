        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-white rounded-lg shadow-md p-6 flex items-center">
              ...
              <div>
                <h3 className="text-lg font-bold mb-2">Support Every Day, 5 AM - 10 PM:</h3>
                <p className="mt-2 text-base text-gray-500">We&apos;re here for you when you need us. Our customer support team is available every day from 5 AM to 10 PM to answer your questions, make changes to your reservations, or help you with any other needs you may have.</p>
              </div>
            </div>
          </div>
        </div>
